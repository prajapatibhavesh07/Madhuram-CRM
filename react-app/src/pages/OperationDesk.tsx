...
const OperationDesk = () => {
    ...
    const handleEditClick = (op: any) => {
        ...
        setOperationFormData({
            ...
            verify: op.verify || 'No',
            noPoachInCV: op.noPoachInCV || 'No',
            removeNoPoach: op.removeNoPoach || 'No',
            readyToMove: op.readyToMove || 'No',
            vehicle: op.vehicle || 'No',
            graduation: op.graduation || 'No',
            degreeCertificate: op.degreeCertificate || 'No',
            rehiring: op.rehiring || 'No',
            remark: op.remark || ''
        });
